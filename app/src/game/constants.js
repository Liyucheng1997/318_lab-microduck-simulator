...
export const POLICIES = {
  ...
  // One-shot vertical jump (custom-trained, Mjlab-Jump-Flat-MicroDuck):
  // crouch, launch, land, return to stand. Commands all zeroed, ~2 s window.
  jump: `${POLICY_DIR}/jump.onnx`,
